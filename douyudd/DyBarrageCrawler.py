from DyBarrageWebSocketClient import DyBarrageWebSocketClient
from DyBarrageRawMsgHandler import *
from DyBarrageDBHandler import *
from DybarrageRedisHandler import dy_barrage_redis_handler
import threading
import time
...
class DyBarrageCrawler:
    ...
    def __receive_msg(self, msg):
        ...
        for chat_message in chat_messages:
            self.__redis_handler.push(chat_message)
